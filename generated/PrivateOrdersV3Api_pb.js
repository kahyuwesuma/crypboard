...
proto.PrivateOrdersV3Api.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lastdealquantity: jspb.Message.getFieldWithDefault(msg, 12, ""),
    ...
    market: jspb.Message.getFieldWithDefault(msg, 17, ""),
    triggertype: jspb.Message.getFieldWithDefault(msg, 18, 0),
    triggerprice: jspb.Message.getFieldWithDefault(msg, 19, ""),
    state: jspb.Message.getFieldWithDefault(msg, 20, 0),
    ocoid: jspb.Message.getFieldWithDefault(msg, 21, ""),
    routefactor: jspb.Message.getFieldWithDefault(msg, 22, ""),
    symbolid: jspb.Message.getFieldWithDefault(msg, 23, ""),
    marketid: jspb.Message.getFieldWithDefault(msg, 24, ""),
    marketcurrencyid: jspb.Message.getFieldWithDefault(msg, 25, ""),
    currencyid: jspb.Message.getFieldWithDefault(msg, 26, "")
  };
